...
class PromptBuilder:
    def build(
        ...
        return (
            ...
            "Required output fields: decision_id,input_summary,assumptions,branches,executive_summary,top_3_risks,recommended_path,overall_recommendation,audit.\n"
            "Branch instruction: generate diverse futures: optimistic, base, pessimistic, wildcard_1, wildcard_2.\n"
            "Each branch must include: branch_name,narrative,key_events,KPIs,risk_clusters,stress_points,failure_triggers,mitigations,llm_stability_score.\n"
            "Add top_3_risks sorted by highest severity and confidence.\n"
            "Add recommended_path with branch_name and 2-4 sentence reasoning.\n"
